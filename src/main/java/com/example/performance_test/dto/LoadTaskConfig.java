...
public class LoadTaskConfig {
	...
	private long delayMillis; // 쿼리 반복 실행 간 대기 시간 (ms)
	...
	// 전체 필드 생성자
	public LoadTaskConfig(String taskName, String testQuery, int concurrency, long delayMillis) {
	...
	public String toString() {
		return "LoadTaskConfig{" + "taskName='" + taskName + '\'' + ", testQuery='" + testQuery + '\''
				+ ", concurrency=" + concurrency + ", delayMillis=" + delayMillis + '}';
	}
}
...
public class TestEzisHashQueryHistoryDto {
	...
	public TestEzisHashQueryHistoryDto(String testName, Integer testTimeSec, String normalizedQueryHash,
			BigDecimal totalCpuCores, BigDecimal totalSystemCpuTime, BigDecimal totalUserCpuTime,

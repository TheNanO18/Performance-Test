...
public class TestStressHistoryDto {
	...
	public TestStressHistoryDto(String testName, Integer testTimeSec, BigDecimal totalCpuCores, BigDecimal totalSystemCpuTime, BigDecimal totalUserCpuTime, LocalDateTime maxTestEndTime) {
